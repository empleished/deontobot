...
This is often described as the autonomy formula. From this, we can derive an approach to validating sets of deontic maxims. One convincing approach is ensuring that every maxim must be consistent with the rest of the set, and that the set must form a coherent system of maxims\cite{Powers}. 
...
\subsection{Non-Monotonic Deontic Logic}%explain what consistency is - talk about defeasibility
