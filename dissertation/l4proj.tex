...
but it seems to have gone some way towards showing that automating deontic reasoning about ethics is possible. 
...
STATUS: success
\end{verbatim}
Recompiling the lexer and parser for the grammar is carried out as follows: 
\begin{verbatim}
